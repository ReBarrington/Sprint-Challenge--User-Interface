...
Semantic HTML adds meaning because it is familiar and also formats the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Inline arranges items in a row, while block arranges them in a column. Block allows you to add width and height. 
...
Allows branching/pull-requests... helps collaboration. Easy access to previous versions. 
